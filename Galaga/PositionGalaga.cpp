...
void PositionGalaga::left(const S& constObject, T& object, float spacing)
{
...
template<typename T, typename S>
void PositionGalaga::right(const S &constObject, T &object, float spacing) {
    sf::FloatRect constBounce = constObject.getGlobalBounds();
...
template<typename T, typename S>
void PositionGalaga::above(const S &constObject, T &object, float spacing) {
    sf::FloatRect constBounce = constObject.getGlobalBounds();
    sf::FloatRect objectBounce = object.getGlobalBounds();
...
template<typename T, typename S>
void PositionGalaga::aboveAndMiddle(const T &constObject, S &object, float spacing) {
...
template<typename T, typename S>
void PositionGalaga::below(const S &constObject, T &object, float spacing) {
    sf::FloatRect constBounce = constObject.getGlobalBounds();
    sf::FloatRect objectBounce = object.getGlobalBounds();
...
template<typename T>
void PositionGalaga::centerText(const T &obj, sf::Text &text, float spacing)
{
...
template<typename T, typename S>
void PositionGalaga::center(const T &constObj, S &obj, float spacing)
{
...
template<typename T, typename S>
void PositionGalaga::alignCenterAndInside(const T &constObj, S &obj, float spacing)
{
    sf::FloatRect cb = constObj.getGlobalBounds();
    float x = cb.left;
    float y = cb.top;
...
template<typename T, typename S>
void PositionGalaga::alignCenter(const T &constObj, S &obj, float margin_x, float margin_y)
{
    sf::FloatRect cb = constObj.getGlobalBounds();
    sf::FloatRect ob = obj.getGlobalBounds();
    float xDif = cb.width - ob.width;
...
template<typename T, typename S>
void PositionGalaga::alignLeft(const T &constObj, S &obj, float margin_x, float margin_y)
{
    sf::FloatRect cb = constObj.getGlobalBounds();
...
template<typename T, typename S>
void PositionGalaga::belowAndAlignCenterForCircle(const T &constObj, S &obj, float spacing)
{
    sf::FloatRect cb = constObj.getGlobalBounds();
...
template<typename T, typename S>
void PositionGalaga::belowAndAlignCenterForCircleInObject(const T &constObj, S &obj, float spacing)
{
    sf::FloatRect cb = constObj.getGlobalBounds();
    float x = ((cb.width / 2) - (obj.getRadius() * 4)) + cb.left;
...
template<typename T, typename S>
void PositionGalaga::centerWithWindow(const T &constObj, S &obj, float spacing)
{
